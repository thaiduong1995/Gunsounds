...
data class AdConfig(
    ...
    @Json(name = "enable_intro")
    var enableIntro: Boolean = false,
    @Json(name = "open_interval")
    var openInterval: Int = 10,
    @Json(name = "banner_interval")
    var bannerInterval: Int = 10,
    @Json(name = "native_interval")
    var nativeInterval: Int = 30,
    @Json(name = "interval")
    var adInterval: Int = 30,
    @Json(name = "app_id")
    ...
    companion object {
        ...
        val emptyValue = AdConfig(
            enable = true, adInterval = 15, openInterval = 10, bannerInterval = 10, nativeInterval = 30
        )
