/*
 * *
 *  * Created by duonglkh on 10/4/23, 4:58 PM
 *  * Copyright (c) 2023 . All rights reserved.
 *  * Last modified 10/4/23, 4:58 PM
 *
 */
...
import com.cemsofwave.gunsimulator.extension.toBitmap
...
class SnowfallView(context: Context, attrs: AttributeSet) : View(context, attrs) {
    ...
    init {
        ...
        try {
            ...
            snowflakeSizeMinInPx = a.getDimensionPixelSize(R.styleable.SnowfallView_snowflakeSizeMin, dpToPx(
                DEFAULT_SNOWFLAKE_SIZE_MIN_IN_DP
            ))
            snowflakeSizeMaxInPx = a.getDimensionPixelSize(R.styleable.SnowfallView_snowflakeSizeMax, dpToPx(
